...
"
        ...
        response = requests.post('https://api.tarkov.dev/graphql',
                                 json={'query': query_cn}, headers=headers, timeout=30, proxies=SYSTEM_PROXY)
        ...
        if response.status_code == 200:
            ...
            # 构建详细信息对象
            ammoMoreInfo = AmmoMoreInfo(resultData["basePrice"], resultData["avg24hPrice"], buyFor, craftsFor)
